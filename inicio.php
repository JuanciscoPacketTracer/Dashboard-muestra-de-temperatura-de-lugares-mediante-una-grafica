...
<!-- UPDATED: Made visible on all screens, icon-only on mobile, full text on sm+ -->
<a href="registro.php" class="inline-flex sm:px-3 px-2 py-1.5 items-center gap-1 sm:gap-1.5 rounded-lg bg-slate-800/60 border border-slate-700/50 text-xs sm:text-sm text-slate-300 hover:text-white hover:border-cyan-500/40 transition-colors" title="Registrar usuarios">
