...
<!-- UPDATED: Added a clear, styled link to the registration page -->
<p class="helper-text text-center">
  ¿Necesitas una cuenta? <a href="registro.php" class="text-cyan-400 hover:text-cyan-300 font-semibold transition-colors">Registrar usuario</a>
</p>
</form>
</section>
</div>
